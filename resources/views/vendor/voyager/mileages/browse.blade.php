        ...
        <div class="row">
            <div class="col-md-12">
                    <div class="panel-body">
                      ...
                      <div class="panel-heading"><h4 style="padding: 3px;">Suivis Kilometrage</h4></div>
         ...
         <table id="dataTable" class="display compact">
                                <thead>
                                    <tr>
                                        @can('delete',app($dataType->model_name))
                                            <th>
                                                <input type="checkbox" class="noExl select_all">
                                            </th>
                                        @endcan
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        @can('delete',app($dataType->model_name))
                                            <td>
                                                <input type="checkbox" class="noExl" name="row_id" id="checkbox_{{ $data->getKey() }}" value="{{ $data->getKey() }}">
                                            </td>
                                        @endcan
                                        @foreach($dataType->browseRows as $row)
                                            <td>
                                        ...
                                        @endforeach
                                        <td class="no-sort noExl no-click" id="bread-actions">
...
@section('javascript')
    ...
    <script>
        $(document).ready(function () {    
                var table = $('#dataTable').DataTable({!! json_encode(array_merge([
                        "order" => [],
                        "paging"=>         true,
...
<script type="text/javascript">
        ...
        console.log('couldnt export table');
});
